...
import com.mustfaibra.roffu.R.*
import com.mustfaibra.roffu.R.string.*
...
import com.mustfaibra.roffu.R.string.login as login1
    ...
    Column(
        ...
        CustomInputField(
            ...
            leadingIcon = {
                Icon(
                    ...
                    painter = painterResource(id = drawable.ic_profile_empty),
            ...
            leadingIcon = {
                Icon(
                    modifier = Modifier
                        .padding(end = Dimension.pagePadding.div(2))
                        .size(Dimension.mdIcon.times(0.7f)),
                    painter = painterResource(id = drawable.ic_lock),
                    contentDescription = null,
                    tint = MaterialTheme.colors.onBackground.copy(alpha = 0.4f),
                )
            },
                ...
                loginViewModel.run {
                    authenticateUser(
                                ...
                                onAuthenticationFailed = {
                                    ...
                                    onToastRequested("Make sure you fill the form where necessary or check your signup/login  info!", Color.Red)
                                }
                            )
                }
            },
        ...
        Row(
            ...
            DrawableButton(
                paddingValue = PaddingValues(Dimension.sm),
                elevation = Dimension.elevation,
                painter = painterResource(id = drawable.ic_apple),
                onButtonClicked = {},
                backgroundColor = MaterialTheme.colors.background,
                shape = MaterialTheme.shapes.medium,
                iconSize = Dimension.mdIcon.times(0.8f),
        ...
        CustomButton(
            ...
            text = stringResource(id = privacy_and_policies),
